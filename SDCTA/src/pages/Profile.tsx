...
export const Profile: React.FC = () => {
  ...
  useEffect(() => {
    userData && currentSave === null && setCurrentSave(userData);
  }, [userData]);
            ...
            <div className="parent_box">
              <div className="profile-info">
                ...
                <label className="label">Phone Number<span style={{ color: "red" }}>*</span>
                  <input className="long-input" type="text" value={userData.phone} name="phone" onChange={(e) => { handleChange(e) }} />
                </label>
                <label className="label">Mailing Address<span style={{ color: "red" }}>*</span>
                  <input className="long-input" type="text" value={userData.address} name="mailing" onChange={(e) => { handleChange(e) }} />
                </label>
                <div className="threeInOne">
                  <div className="cityDiv">
                    <label className="label-short">City<span style={{ color: "red" }}>*</span>
                      <input className="short-input" type="text" value={userData.city} name="city" onChange={(e) => { handleChange(e) }} />
                    </label>
                  </div>
                  <div className="threeBlockDiv">
                    <label className="label-short">State<span style={{ color: "red" }}>*</span>
                      <select className="stateDrop" name="state" value={userData.state} onChange={(e) => { handleChange(e) }}>
                  ...
                  <div className="threeBlockDiv">
                    <label className="label-short">Zip Code<span style={{ color: "red" }}>*</span>
                      <input className="short-input" type="text" value={userData.zipCode} name="zipCode" onChange={(e) => { handleChange(e) }} />
                    </label>
                    {/* <label className="label-short">Zip Code<span style={{ color: "red" }}>*</span>
                ...
                <label className="label">Country<span style={{ color: "red" }}>*</span>
                  <select className="long-input" name="country" value={userData.country} onChange={(e) => { handleChange(e) }}>
